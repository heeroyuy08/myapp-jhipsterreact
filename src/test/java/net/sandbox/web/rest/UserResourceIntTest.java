package net.sandbox.web.rest;

import net.sandbox.JhipsterApp;
import net.sandbox.domain.Authority;
import net.sandbox.domain.User;
import net.sandbox.repository.UserRepository;
import net.sandbox.security.AuthoritiesConstants;
import net.sandbox.service.MailService;
import net.sandbox.service.UserService;
import net.sandbox.service.dto.UserDTO;
import net.sandbox.service.mapper.UserMapper;
import net.sandbox.web.rest.errors.ExceptionTranslator;
import net.sandbox.web.rest.vm.ManagedUserVM;
